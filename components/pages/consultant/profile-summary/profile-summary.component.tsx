    ...
    return ( 
        ...
        <div className="w-full flex items-center mt-4 md:mt-[30px] justify-between gap-5 md:gap-0" >
            ...
            {!isSuccess ? <Skeleton className="  w-[114px] h-[60px] rounded-[114px]" /> : <>
                <AvatarWithBadge isVerified={isVerified} profile_image={singleUser?.profile_image} width={114} height={0} className="w-[100px] h-[65px] rounded-[100px] md:w-[90px] md:h-max md:rounded-[90px] lg:w-[117px] lg:h-[11p7x] lg:rounded-[100px] " />
                </>
}
            </div>
