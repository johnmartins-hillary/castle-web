...
const YourCirlceBanner = () => {
    ...
    return (  
        ...
        <div className="w-full hidden md:flex flex-col p-[23px] items-center justify-between md:p-[35px] rounded-[24px] bg-primary_color mt-1 md:flex-row lg:p-[43px] 2xl:w-[65%] 2xl:mx-auto" >
        ...
        <Image src={'/images/circle-mobile-banner.png'} width={362} height={160} alt="verfied-banner" className=" w-[362px] h-[160px]" />
        </div>
        </>
    );
}
