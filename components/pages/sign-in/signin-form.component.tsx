...
const SignInForm = () => {
  ...
  const [
    signInUser,
    { isLoading, isSuccess, error, isError, data: signInData }
  ]: any = useSignInUserMutation();
      ...
      <div className=" lg:w-1/3 flex flex-col items-center justify-center mt-10  md:max-lg:w-2/5 w-[85%]  ">
        ...
        <div className="w-full mt-10 flex items-center justify-center ">
          <Button
            ...
            className=" w-full md:w-96 bg-light_grey rounded-2xl text-black hover:bg-slate-200 hover:text-black cursor-pointer  py-7 md:max-lg:w-full"
          >
            <GoogleIcon
              color={""}
              onClick={() => {}}
        ...
        <div className="w-full mt-9">
          ...
          <div className="w-full">
            <Input
              ...
              {...register("email")}
              id="email"
              className="w-full bg-light_grey rounded-2xl text-black py-6  outline-none "
            />
          </div>
        ...
        <div className="w-full mt-3">
          ...
          <div className="w-full">
            <div className="w-full bg-light_grey rounded-2xl text-black py-2 md:py-2 px-[12px]  flex items-center justify-between">
              <Input
          ...
          <div className="mt-2 w-full">
            <p className="text-right text-xs font-normal italic ">
              ? Forgot password
            </p>
          </div>
        </div>
